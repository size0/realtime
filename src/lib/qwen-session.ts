      ...
      tools: [
        {
          ...
          function: {
            ...
            description:
              "为用户当前这轮发言生成最终答案。每一轮都必须调用；返回内容将由 Tina 原样朗读。",
            parameters: {
